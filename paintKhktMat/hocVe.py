...
def hocVe(lang):
    ...
    def renderBackground():
        for i in range(0, 12):
            cv2.line(img, (258, 200 + i * 110), (1920 - 241, 200 + i * 110), gray, thickness=1)
        for i in range(0, 13):
            cv2.line(img, (258 + 110 * i, 201), (258 + 110 * i, 1080), gray, thickness=1)
    ...
    while cap.isOpened():
        ...
        if pointCheck == True and percent != 0:
            passPoint = pointList[min(10, int(percent) // 10 + 2)]
